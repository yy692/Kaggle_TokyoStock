...
def group_by_sectors(stock_list_path, data_path, write_path, sector_path, isTraining):
    ...
    '''
    sector = {}
    with open(stock_list_path, newline='') as csvfile:
    ...
    for sec_code in sec_list:
        sector_list[sector[sec_code[:-4]]].append(sec_code[:-4])
...
def preprocessing():
    train_path = 'input/jpx-tokyo-stock-exchange-prediction/train_files/stock_prices.csv'
    sup_path = 'input/jpx-tokyo-stock-exchange-prediction/supplemental_files/stock_prices.csv'
    train_save_path = 'working/train/'+ 'stocks/'
    sup_save_path = 'working/sup/' + 'stocks/'
    stock_list_path = 'input/jpx-tokyo-stock-exchange-prediction/stock_list.csv'
    
    all_path = 'working/all/'
    all_stock_path = 'working/all/' + 'stocks/'
    all_sector_path = 'working/all/' + 'sectors/'
    
    sector_path = 'working/sector_list/'
